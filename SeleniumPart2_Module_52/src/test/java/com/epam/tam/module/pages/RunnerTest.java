...
public class RunnerTest {
    ...
    public void verifyOriginValue(){
    	Assert.assertEquals("Wrong Airport value taken", originAirport, homePage.originField(originCountry));
    }
    @Test(priority =3)
    public void verifyDestinationValueNegative(){
    	Assert.assertEquals(destinationCountry1+" Country had Airports", destinationResult, homePage.destinationFieldNegative(destinationCountry1));
    }
    @Test(priority =4)
    public void verifyDestinationValue(){
    	Assert.assertEquals("Wrong Airport value taken for country "+destinationCountry2, destinationAirport, homePage.destinationField(destinationCountry2));
    }
    @Test(priority =5)
