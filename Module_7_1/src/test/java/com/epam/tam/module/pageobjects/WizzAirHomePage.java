...
public class WizzAirHomePage extends BasePage{
    ...
    public String verifyHomePage(){
    	logger.info("Successfully opened home page");
    	   return   HomePageText.getText();
    }
    public String originField(Country country){
    	origin.click();
    	origin.sendKeys(country.getoriginCountry());
    	logger.info("Successfully entered Origin country in home page");
    	originAirport.click();
    	logger.info("Selected the required airport");
    ...
    public String destinationFieldNegative(Country country){
    	...
    	logger.info("Successfully verified Negative test");
    ...
    public String destinationField(Country country){
    	...
    	logger.info("Successfully entered destination country");
    	destinationAirport.click();
    	logger.info("Selected required destination airport");
    ...
    public String selectPassengers(){
    	...
    	logger.info("Increaded child count");
